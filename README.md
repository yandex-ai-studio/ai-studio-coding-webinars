# Материалы к вебинарам по курсу AI Studio

В этом репозитории содержатся материалы к вебинарам по курсу "AI Studio для программирующих людей". Открыть каждый из ноутбуков для выполнения вы можете в среде Google Colab или Binder, нажав на кнопки в правой колонке.
